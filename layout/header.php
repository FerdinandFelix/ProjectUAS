    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">SI CATERING V1</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse"> 
          <ul class="nav navbar-nav navbar-right">
            <li><a href="index.php">Home</a></li>
            <li><a href="menu.php">Menu Katering</a></li> 
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div style="background:#ffffff; width:100%; height:auto; padding-top:3px;padding-bottom:3px; padding-left:10px; border: 1px dashed #000;">
